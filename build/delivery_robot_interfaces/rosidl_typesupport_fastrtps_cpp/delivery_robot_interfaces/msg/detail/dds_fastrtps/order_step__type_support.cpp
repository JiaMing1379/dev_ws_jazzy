...
#include "delivery_robot_interfaces/msg/detail/order_step__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const delivery_robot_interfaces::msg::OrderStep & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.earliest_arrival_time,
    cdr);

  // Member: latest_arrival_time
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.latest_arrival_time,
    cdr);

  // Member: service_time
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.service_time,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  delivery_robot_interfaces::msg::OrderStep & ros_message)
{
  // Member: order_index
  cdr >> ros_message.order_index;
  ...
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.earliest_arrival_time);

  // Member: latest_arrival_time
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.latest_arrival_time);

  // Member: service_time
  builtin_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.service_time);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = delivery_robot_interfaces::msg::OrderStep;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const delivery_robot_interfaces::msg::OrderStep *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<delivery_robot_interfaces::msg::OrderStep *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _OrderStep__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const delivery_robot_interfaces::msg::OrderStep *>(
...
static size_t _OrderStep__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_OrderStep(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _OrderStep__callbacks = {
...
static rosidl_message_type_support_t _OrderStep__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_OrderStep__callbacks,
...
{
  return &delivery_robot_interfaces::msg::typesupport_fastrtps_cpp::_OrderStep__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, delivery_robot_interfaces, msg, OrderStep)() {
  return &delivery_robot_interfaces::msg::typesupport_fastrtps_cpp::_OrderStep__handle;
}

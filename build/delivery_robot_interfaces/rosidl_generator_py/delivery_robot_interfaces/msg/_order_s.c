...
bool delivery_robot_interfaces__msg__order__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("delivery_robot_interfaces.msg._order.Order", full_classname_dest, 42) == 0);
  }
  delivery_robot_interfaces__msg__Order * ros_message = _ros_message;
  {  // order_index
  ...
  {  // order_time
    ...
    if (!builtin_interfaces__msg__time__convert_from_py(field, &ros_message->order_time)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // steps
    ...
    if (!delivery_robot_interfaces__msg__OrderStep__Sequence__init(&(ros_message->steps), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create delivery_robot_interfaces__msg__OrderStep__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    delivery_robot_interfaces__msg__OrderStep * dest = ros_message->steps.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!delivery_robot_interfaces__msg__order_step__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * delivery_robot_interfaces__msg__order__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("delivery_robot_interfaces.msg._order");
  ...
  {  // order_time
    PyObject * field = NULL;
    field = builtin_interfaces__msg__time__convert_to_py(&ros_message->order_time);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // steps
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = delivery_robot_interfaces__msg__order_step__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }

...
static const _Order_type_support_symbol_names_t _Order_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, delivery_robot_interfaces, msg, Order)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, delivery_robot_interfaces, msg, Order)),
  }
};
...
{
  return &::delivery_robot_interfaces::msg::rosidl_typesupport_cpp::Order_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, delivery_robot_interfaces, msg, Order)() {
  return get_message_type_support_handle<delivery_robot_interfaces::msg::Order>();
}
